    ...
    in
    {
      ...
      nixosModules = {
        nixobolus = {
          ...
          user = { pkgs, config, inputs, ... }: {
            options = nxbls.options.user;
            config = nxbls.config.user;
          };
          ssh = { config, pkgs, ... }: {
          ...
          lighthouse = { config, pkgs, ... }: {
            options = nxbls.options.lighthouse;
            config = nxbls.config.lighthouse;
          };
          mev-boost = { config, pkgs, ... }: {
            options = nxbls.options.mev-boost;
            config = nxbls.config.mev-boost;
          };
        };
      };
    };
